...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>部门类别:</td>
    <td width=70%><input id="department.departmentType" name="department.departmentType" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>备注:</td>
    <td width=70%><textarea id="department.departmentMemo" name="department.departmentMemo" rows="5" cols="50"></textarea></td>
  </tr>
