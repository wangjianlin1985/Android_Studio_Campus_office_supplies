...
public class DepartmentListHandler extends DefaultHandler {
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (department != null) { 
            ...
            else if ("departmentType".equals(tempString)) 
            	department.setDepartmentType(valueString); 
            else if ("departmentMemo".equals(tempString)) 
            	department.setDepartmentMemo(valueString); 
        } 
	}
