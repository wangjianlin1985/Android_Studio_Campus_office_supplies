...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_user_name.setText("人员编号：" + mData.get(position).get("user_name").toString());
	  ...
	  try {holder.tv_bornDate.setText("出生日期：" + mData.get(position).get("bornDate").toString().substring(0, 10));} catch(Exception ex){}
	  /*返回修改好的view*/
	  return convertView; 
    } 
